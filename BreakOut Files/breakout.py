...
def main_game(player_count, difficulty, background):
    ...
    left_button_down2 = False
    right_button_down2 = False
    ...
    while keepGoing:
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if player_count == 2:
                    if event.key == pygame.K_a:
                        left_button_down2 = True
                    if event.key == pygame.K_d:
                        right_button_down2 = True
        ...
        if player_count == 2:
            ...
            if left_button_down2 == right_button_down2:
                direction2 = 0
            elif left_button_down2:
                direction2 = -1
            elif right_button_down2:
                direction2 = 1
